...
const carouselItemStyle = 'basis-1/2 sm:basis-1/3 lg:basis-1/4 xl:basis-1/5';
...
const Popular = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col items-start justify-start bg-white pb-10 px-4 lg:px-10 xl:px-20 min-[2560px]:px-40 font-poppins min-[2560px]:py-20">
            ...
            <p className='text-[12px] lg:text-sm min-[2560px]:text-xl w-full sm:w-[448px] min-[2560px]:w-[630px] leading-5 max-sm:leading-4 text-justify mb-8'>
